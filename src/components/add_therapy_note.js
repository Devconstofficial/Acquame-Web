...
function AddTherapyNoteModal({ isOpen, onClose }) {
  ...
  return (
    <ModalOverlay>
      <ModalContainer>
        ...
        <Label>Summary</Label>
        <InputField type="text" placeholder="Enter note summary" />
        <Label>
          Notes
        </Label>
        ...
        <ButtonContainer>
          ...
          <AddGoalButton onClick={onClose}>Add Note</AddGoalButton>
        </ButtonContainer>
      </ModalContainer>
    </ModalOverlay>
  );
...
export default AddTherapyNoteModal;
